...
from information_schema.columns
    ...
    left join information_schema.table_constraints tc        on tc.constraint_name = kcu.constraint_name and tc.table_name = columns.table_name and tc.constraint_type = 'FOREIGN KEY'
